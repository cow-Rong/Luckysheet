...
const luckysheetIconFont = function () {
    return 'normal normal normal ' + (Store.defaultFontSize - 1) + 'pt ' + locale().fontarray[1] + ', "Helvetica Neue", Helvetica, Arial, "PingFang SC", "Hiragino Sans GB", "Heiti SC",  "WenQuanYi Micro Hei", sans-serif';
}
...
function customCellRightClickConfig() {
    const config = {
        ...
        columnFormat: true // Set column format
	}
